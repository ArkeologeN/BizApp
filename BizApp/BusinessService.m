...
+(NSArray*)getSampleData
{
    ...
    BusinessService* service4 = [[BusinessService alloc] initWithCaption:@"Family Law" andImage:[UIImage imageNamed:@"service-4.png"] andWebContentTitle:@"Family Law: Make the right choice" andWebContent:content andWebContentImage:[UIImage imageNamed:@"service-4.jpg"]];
    
    BusinessService* service5 = [[BusinessService alloc] initWithCaption:@"Mergers" andImage:[UIImage imageNamed:@"service-5.png"] andWebContentTitle:@"Mergers: Hamony between companies" andWebContent:content andWebContentImage:[UIImage imageNamed:@"service-5.jpg"]];
